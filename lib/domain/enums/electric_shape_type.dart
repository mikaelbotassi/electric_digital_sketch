...
/// Catalog of electrical symbols and basic geometric shapes supported
/// by the editor.
enum ElectricShapeType {
  ...
  /// Native [ShapeType] used by `simple_painter` when the item is geometric.
  final ShapeType? type;

  /// Prebuilt custom widget used for electrical symbols.
  final Widget? customWidget;

  /// Icon shown in shape selection controls.
  final Widget icon;

  /// Human-readable item description.
  final String desc;

  /// Group label used to organize the catalog in the UI.
  final String group;

  /// Suggested layer title when this shape is inserted into the sketch.
  String get layerTitle => '$group - $desc';

  /// All shape values grouped by [group].
  ...
  /// Returns the shapes registered for a specific group name.
